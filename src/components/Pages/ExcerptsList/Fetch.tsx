      ...
      edges {
        node {
          frontmatter {
            ...
            thumbnail {	
              childImageSharp {	
                gatsbyImageData(width: 180, height: 100, quality: 60, layout: FIXED, formats: [AUTO, AVIF])
              }	
            }
          }
        }
      ...
      edges {
        node {
          frontmatter {
            ...
            thumbnail {
              childImageSharp {
                gatsbyImageData(width: 650, height: 360, quality: 60, layout: CONSTRAINED, formats: [AUTO, AVIF])
              }
            }
          }
        }
