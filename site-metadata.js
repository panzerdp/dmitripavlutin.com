...
module.exports = {
  ...
  affiliates: [{
    ...
    text: `
        ...
        <p>
        Take <a href="__URL___" target="_blank" rel="noopener">"Modern JavaScript From The Beginning 2.0"</a> course by Brad Traversy to become proficient in JavaScript. Use the coupon code DMITRI and get your 20% discount!
        </p>`,
    ...
    text: `
      ...
      <p>
        Take the course <a href="__URL___" target="_blank" rel="noopener">"Vue 3 Composition API"</a> by Vueschool to become proficient in Vue composition and reactivity in just a weekend. Hurry up since they offer a 40% discount!
      </p>`,
