...
function Child = forwardRef(function(props, ref) {
  return <GrandChild ref={ref} />
})

function GrandChild = forwardRef(function(props, ref) {
...
```
[Open the demo.](https://codesandbox.io/s/eloquent-burnell-3vrm0o?file=/src/Main.tsx)
