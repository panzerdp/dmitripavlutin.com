...
In JavaScript a function is composed from many parts:
...
In case of function expressions the JavaScript statement **does not start** with `function` keyword (it is somewhere in the middle of the statement code): 
