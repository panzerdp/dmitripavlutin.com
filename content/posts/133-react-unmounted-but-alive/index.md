...
It's up to you to decide whether or not it worths aborting the requests that are generate by prop or state changes. The general rule of thumb is that the heaver and the longer it takes the request to complete, the better chances are that you need to handle their cancelling.   
