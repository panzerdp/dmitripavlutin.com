...
![React useEffect() Hook: when callback is invoked](./images/callback-2.svg)
...
![React useEffect() Hook: when callback and cleanup are invoked](./images/callback-cleanup-2.svg)
