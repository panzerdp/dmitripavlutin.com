...
![React useEffect() Hook: when callback is invoked](./images/use-effect-2.png)
...
![React useEffect() Hook: when callback and cleanup are invoked](./images/use-effect-cleanup-2.png)
